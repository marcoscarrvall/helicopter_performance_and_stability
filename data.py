class ApacheAH64:
    ...
    helicopter = {
        ...
        "flat_plate_area": 1.5,       # [m²]  fuselage equivalent flat plate area, from PDF Fig. 2, gross weight ~78.5 kN → 1.5 m²)
    ...
    main_rotor = {
        ...
        "cd_p": 0.0131,                # [-] Mean profile drag coefficient
        "k": 1.15,                   # [-] Induced drag power factor
        "M_t_mr": 0.65,             # [-] Mach number at tip = (omega * R) / a = (30.25 * 7.3152) / 340.29 = 0.65
        "FM": 0.74                   # [-] Figure of Merit in ACT theory [NASA]
    }
    ...
    tail_rotor = {
        ...
        "cd_p_tr": 0.0058,             # [-] Tail rotor profile drag coefficient
        "k_tr": 1.4,                 # [-] Tail rotor induced drag factor (1.3 - 1.5) [5, 6]
        "fin_blockage": 1.1,          # [-] Vertical fin blockage factor [5, 6]
        "M_t_tr": 0.605                 # [-] Tail rotor Mach number at tip = (omega_tr * R_tr) / a = (147.17 * 1.3975) / 340.29 = 0.605
    }
    ...
    flight_condition = {
        "rho": 1.225,
        "a": 340.29,                 # [m/s] Speed of sound at sea level                
        "V": None,                   
        "C": 0.0,                    
